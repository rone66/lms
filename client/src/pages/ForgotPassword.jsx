            ...
            loading ? (
                ...
                <div className="max-w-[500px] p-4 lg:p-8 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-md">
                    ...
                    <form onSubmit={handleOnSubmit}>
                          {
                            !emailSent && (
                                ...
                                <label className="w-full">
                                    <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-800">Email Address</p>
                                    <input
                                        required
                                        type='email'
                                        name='email'
                                        ...
                                        className="form-style w-full bg-richblack-800 text-richblack-5 px-[8px] py-[12px] rounded-md"
                                        />
                                </label>
                    ...
                    <div className="mt-6 flex items-center justify-between">
                        <Link to="/login">
                            <p className="flex items-center gap-x-2 text-pink-400">
